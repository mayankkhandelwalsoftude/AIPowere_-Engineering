...
CREATE TABLE IF NOT EXISTS learning_plans (
  ...
  title TEXT NOT NULL,
  plan_type TEXT CHECK (plan_type IN ('GenAI','AI Engineering','MLOps','Data Engineering','AI Agents','LLMOps','RAG','MCP','Cloud AI','AI Security','Custom')),
...
CREATE TABLE IF NOT EXISTS learning_tasks (
  ...
  title TEXT NOT NULL,
  description TEXT,
  task_type TEXT CHECK (task_type IN ('Learning','Coding','Documentation','POC','Demo','Assessment','Certification','Project')) DEFAULT 'Learning',
  due_date DATE,
  ...
  demo_url TEXT,
  jira_link TEXT,
  status TEXT CHECK (status IN ('Pending','In Progress','Done','Skipped','Blocked')) DEFAULT 'Pending',
  completed_date DATE,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
